...
class ResolverTest < Minitest::Test
  def test_database_resolver
    resolver = Apartment::Resolvers::Database.new(Apartment.connection_db_config.configuration_hash)
  ...
  def test_schema_resolver
    ...
    resolver = Apartment::Resolvers::Schema.new(Apartment.connection_db_config.configuration_hash)
    new_config = resolver.resolve("foobar")
